...
const Solution = () => {
  return (
    <section className="min-h-screen p-5 md:p-16 relative z-50 bg-lightGray-color flex flex-col items-center justify-center">
      <div className="w-[90%] md:w-[80%] flex flex-col gap p-9 pb-10 items-center justify-center">
        <TitleText title={<>Our Solution </>} textStyles="text-center" />
        <p className="font-normal  text-[20px]  text-center">
          Celestial Crafters Digital Skill Centre <span className="font-[800] text-lightRed"> will offer free digital skills </span> 
