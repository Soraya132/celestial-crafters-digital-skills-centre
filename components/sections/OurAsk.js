      ...
      >
        <div className="relative  flex justify-center items-center">
          <Image
            ...
            width={1000}
            height={1000}
            className="w-full lg:h-[500px] h-auto min-h-[210px] rounded-md object-cover"
          />
        </div>
        <div className="flex justify-end flex-col gradient-05 sm:p-8 p-4  relative">
          ...
          <p className="py-6 font-normal  text-[20px]">
            ...
            the leading global institution{" "}
            <span className="font-bold text-black">
              that offers free and quality digital skills to the vulnerable
              women{" "}
            </span>
            in the society.
          </p>
          <ul className="flex flex-col ">
            {[
              ...
              return (
                <li className="py-2 font-[500]  text-[22px]">
                  <span>{index + 1}</span>
                  {") "}
                  {item}
                </li>
