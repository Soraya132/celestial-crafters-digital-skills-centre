...
const Footer = () => (
  ...
  className="flex justify-center items-center sm:pt-16 pt-6  flex-col bg-lightGray-color">
    <div className={`flex justify-center items-start md:flex-row flex-col mb-8 w-full px-5 md:px-10`}>
      <div className="flex-[1] flex flex-col justify-start mr-10">
      <Link href={"/"}>
          <Image src={"/logo-removebg-preview.png"} alt="logo" width={150} height={10} className="w-[175px]" />
        </Link>
        <p className={`font-poppins font-normal text-lightRed text-[18px] leading-[30.8px] mt-4 max-w-[312px]`}>
        Transforming Lives in Nairobi's Slums, Empowering Women for
a Digital Future with Celestial Crafters
        </p>
      </div>
    ...
    <div className="w-full py-5 pb-8 px-6 bg-lightRed flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
        Copyright Ⓒ 2022 Celestial Crafters Digital Skills Centre. All Rights Reserved.
      </p>
